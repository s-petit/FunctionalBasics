...
public final class Identity<A> implements Applicative<A, Identity> {
 ...
 /*   @Override
    ...
    @Override
    public <B> Identity<B> apply(Applicative<Function<? super A, ? extends B>, Identity> appFn) {
        return new Identity<>(((Identity<Function<? super A, ? extends B>>) appFn).runIdentity().apply(a));
    }
